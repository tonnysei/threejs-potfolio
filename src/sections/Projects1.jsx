...
import { myProjects1 } from '../constants/index.js';
import CanvasLoader from '../components/Loading.jsx';
import DemoComputer from '../components/DemoComputer.jsx';

const projectCount = myProjects1.length;
...
const Projects1 = () => {
  ...
  useGSAP(() => {
    gsap.fromTo(`.animatedText`, { opacity: 0 }, { opacity: 1, duration: 0.5, stagger: 0.2, ease: 'power2.inOut' });
    ...
    <section className="c-space my-20">
      <div class="max-w-3xl mx-auto text-center mt-16 mb-9">
          <h1 class="text-5xl font-bold text-gray-900 leading-tight mb-2 pb-4 relative">
              ...
              <span class="absolute bottom-0 left-0 w-full h-1 bg-gradient-to-r to-purple-500 from-blue-600"></span>
          </h1>
      </div>
